export const home = {
  ...
  vision: {
    ...
    introMain: "At Pools 4 You, we believe water is more than a feature, it’s an experience. It shapes environments, defines spaces, and elevates how people relax. Backed by years of hands-on experience across diverse residential, hospitality, and commercial projects, we bring proven insight to every stage of delivery. ",
    introSecondary: "From concept to completion, we design and execute aquatic solutions that combine engineering precision with lasting beauty. Because every project is personal, we tailor every detail according to your vision. ",
    accents: [
        {
          id: "experience",
          title: "Experience",
